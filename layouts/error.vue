...
<style>
        ...
        .content .wrap .ghost:nth-of-type(3) {
            width: 200px;
            height: 200px;
            display: block;
            left: 240px;
        ...
        .content .wrap .ghost:nth-of-type(3) .inner {
            width: 50px;
            height: 75px;
            left: 100px;
        ...
        .content .wrap .ghost:nth-of-type(3) .inner:before {
            content: '';
            position: absolute;
            width: 4px;
            height: 4px;
        ...
        .content .wrap .ghost:nth-of-type(3) .inner:after {
            content: '';
            position: absolute;
            width: 200px;
            height: 125px;
        ...
        .content .wrap .ghost:nth-of-type(2) {
            display: block;
            top: 80px;
            right: 150px;
        }
        .content .wrap .ghost:nth-of-type(2) .inner {
        ...
        .content .wrap .ghost:nth-of-type(2) .inner:before {
            content: '';
            position: absolute;
            width: 4px;
            height: 4px;
        ...
        .content .wrap .ghost:first-of-type {
            top: 65px;
            left: 50px;
        ...
        .content .wrap .ghost:first-of-type .inner {
            -webkit-animation: peek1 10s ease-in-out infinite alternate;
            animation: peek1 10s ease-in-out infinite alternate;
            -webkit-transform: translateY(100%);
            transform: translateY(100%);
        }
        .content .wrap .ghost:first-of-type .inner:before {
            content: '';
            position: absolute;
            width: 4px;
            height: 4px;
